...
class Repository(ABC):
    ...
    def _get_aggregate_type(self) -> Type[AggregateRoot]:
        ...
        raise NotImplementedError("Subclasses must implement _get_aggregate_type")
    ...
    def get_by_id(self, aggregate_id: str) -> Optional[AggregateRoot]:
        ...
        try:
            ...
            raise SkafuException(f"Failed to get aggregate: {str(e)}") from e
    ...
    def save(self, aggregate: AggregateRoot, expected_version: Optional[int] = None) -> None:
        ...
        try:
            ...
            raise SkafuException(f"Failed to save aggregate: {str(e)}") from e
...
class SecurityEventResource:
    """Security event resource information"""
    resource_id: str = ""
    region: str = ""
    account_id: str = ""
    finding_id: str = ""
...
class SecurityEvent(BaseModel):
    ...
    title: str = ""
    description: str = ""
    resource: SecurityEventResource = field(default_factory=SecurityEventResource)
